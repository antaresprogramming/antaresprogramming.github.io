...
image: /images/posts/cascading-inheritance-specificity/cover.png
seo_image: /images/posts/cascading-inheritance-specificity/seo-cover.png
...
<pre><code data-language="html">&lt;h1 style="color: red;">This is a red headline&lt;/h1></code></pre>

Sa unang rule na inilagay natin sa CSS, sinubukan nating baguhin ang kulay ng text at gawin itong `blue`:

<pre><code data-language="css">h1 {
  color: blue;
}</code></pre>
